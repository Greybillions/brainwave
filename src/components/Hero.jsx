        ...
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
          <div className="relative p-0.5 rounded-2xl bg-conic-gradient z-10">
            <div className="relative bg-n-8 rounded-[1rem] ">
              ...
              <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1023/490]">
                <img
                  src={robot}
                  className="w-full scale-1.7  md:-translate-y-[10%] lg:-translate-y-[23%]"
                  width={1024}
                  height={490}
                  alt="AI"
                />
          ...
          <div className="absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:-top-[45%] md:w-[138%] lg:-top-[108%]">
            <img
              src={heroBackground}
              alt="HeroBackground"
              className="w-full"
